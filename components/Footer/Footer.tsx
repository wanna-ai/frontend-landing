...
const Footer = () => {
  ...
  if (pathname.includes('/chat') || pathname.includes('/login/success') || pathname.includes('/preview') || pathname.includes('/register') || pathname.includes('/visibility') || pathname.includes('/story') || pathname.includes('/result')) {
    return null
  }
