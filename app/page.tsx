    ...
    <>
      <div className={styles.home}>
        ...
        <div className={styles.home__content}>
          <div className={styles.home__content__hero}>
            ...
            <div className={styles.home__content__hero__content}>
              <h1 className={styles.home__content__hero__content__title}>Cuéntale a <span className={styles.home__content__hero__content__title__span}>Wanna</span> algo que te haya pasado...</h1>
            ...
            <Image className={styles.home__content__hero__image} src="/example_square.svg" alt="Home Image Chat" width={747} height={747} />
        ...
        <div className={styles.home__content__checks}>
          <Check text="Puede ser algo cotidiano, divertido o profundo. Tu decides." color="#FF00BB" />
          <Check text="Déjate fluir. Wanna te guía." color="#00A6FF" />
          {/* <Check text="No necesitas tener nada pensado. Déjate guiar." color="#00A6FF" /> */}
          {/* <Check text="Tu privacidad es importante." color="#FF8000" /> */}
        </div>
...
const Check = ({text, color}: {text: string, color: string}) => {
  return (
    <div className={styles.check}>
      <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M6.75 8.25L10.25 11.75L19.2502 1.75" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
