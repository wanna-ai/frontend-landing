...
export default function BriefPage() {
  ...
  return (
    <div className={styles.brief}>
      ...
      <h1 className={styles.brief__title}>Esta es tu historia</h1>

      <div className={styles.brief__experience}>
        <div className={styles.brief__experience__header}>
          ...
          <h1 className={styles.brief__experience__hedaer__title}>{data.title}</h1>
        </div>
        
        <p className={styles.brief__experience__content}>
          {isExpanded ? (
            <>
              {data.content}
            </>
              ...
              {shouldShowMore && (
                <>
                  ...
                  <span 
                    ...
                    className={styles.brief__experience__more}
                  >
                    más
                  </span>
                </>
        ...
        {(!shouldShowMore || isExpanded) && (
          <div className={styles.brief__experience__pills}>
      ...
      <div className={styles.brief__reflection}>
        <div className={styles.brief__reflection__header}>
          ...
          <h2 className={styles.brief__reflection__header__title}>Reflexión (solo para ti)</h2>
        </div>
        <p>{data.reflection}</p>
      </div>

      <button className={styles.brief__button} onClick={() => router.push(communityId ? `/edit?c=${communityId}` : '/edit')}>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
