  ...
  return (
    <>
      <div className={styles.visibility}>
        <h1 className={styles.visibility__title}>Decide quién puede ver tu historia</h1>
        ...
        <div className={styles.visibility__privacy}>
          <h2 className={styles.visibility__privacy__title}>Decide quién puede ver tu historia</h2>
