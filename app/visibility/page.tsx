    ...
    <>
      <div className={styles.visibility}>
        <div className={styles.visibility__privacy}>
          <div className={styles.visibility__privacy__header}>
            <p className={styles.visibility__privacy__header__title}>Decide quién puede verla:</p>
          </div>
          <div className={styles.visibility__privacy__options}>
            <label className={styles.visibility__privacy__options__option}>
              ...
              <div className={styles.visibility__privacy__options__option__content}>
                <div className={styles.visibility__privacy__options__option__radio}></div>
                <div className={styles.visibility__privacy__options__option__content__text}>
            ...
            <label className={styles.visibility__privacy__options__option}>
              ...
              <div className={styles.visibility__privacy__options__option__content}>
                ...
                <div className={styles.visibility__privacy__options__option__content__text}>
                  ...
                  <p className={styles.visibility__privacy__options__option__description}>
                    Solo visible para ti y quien tú decidas
                  </p>
                </div>
              </div>
            </label>
        ...
        {experienceData?.story_valuable && (
          <div className={styles.visibility__value}>
            <div className={styles.visibility__value__header}>
              <svg className={styles.visibility__value__header__svg} width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
